...
using MultipleImageApp.Droid.Helpers;
using MultipleImageApp.Helpers;
using MultipleImageApp.Models;
using MultipleImageApp.Services;
using Plugin.CurrentActivity;
using Environment = System.Environment;

namespace MultipleImageApp.Droid.Services
{
    ...
    public class MultiMediaPickerService : IMultiMediaPickerService
    {
        ...
        async Task<IList<MediaFile>> PickMediaAsync(string type, string title, int resultCode)
        {
            ...
            //((Activity) mContext).startActivityForResult(imageIntent, resultCode);
            //Android.App.Application.Context.StartActivity(Intent.CreateChooser(imageIntent, title));
